...
public class ByteUtil {
    ...
    Converts int to a byte array with the lower byte first
    and the higher byte next
    ...
    */
     ...
     * Converts a byte array with the lowest byte first and the highest byte last to an int
    */
    ...
    /**
     * Byte data is converted to a hexadecimal string
     * @param b
     * @return
     */
    ...
    /**
     * The short variable is converted from the least significant byte first to the most significant byte last
     */
    ...
    /**
     * The int variable is converted from the least significant byte first to the most significant byte last
     */
    ...
    /**
     * The long variable is converted from the least significant byte first to the most significant byte last
     */
